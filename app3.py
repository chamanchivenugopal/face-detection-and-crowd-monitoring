...
model = load_model(r'C:\Users\chama\OneDrive\Desktop\4-2 PROJECT\Extracted file\crowd\modelnew.h5')
...
def predict_violence(sequence):
    ...
    label = "Violence" if prediction[0][0] > 0.75 else "Non-violence"
    return label, confidence

# Function to send email
def send_email(subject, message, image, time):
    sender_email = "dheeru9898@gmail.com"
    password = "enhr axvf cgjt rrpe"
    receiver_email = "k.dheeru43210@gmail.com"
...
# Open video file for capturing video
cap = cv2.VideoCapture(r"C:\Users\chama\OneDrive\Desktop\4-2 PROJECT\Extracted file\crowd\videos\violence.mp4")
...
while True:
    ...
    if len(frame_sequence) == SEQUENCE_LENGTH:
        ...
        if confidence>0.7:
            ...
            if frame_prediction == "Violence":
                total_violent_frames += 1
                if total_violent_frames == 5:  # Adjust the number of frames to your requirement
...
# Release the video file capture object and close all windows
cap.release()
